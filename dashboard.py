...
ax.plot(
    daily_orders_df["order_purchase_timestamp"].values,
...
sns.barplot(x="count", y="product_category_name_english", data=sum_order_items_df.sort_values(by="count", ascending=True).head(5), palette=colors, ax=ax[1])
...
ax[0].tick_params(axis='x', labelsize=35, labelrotation=90)
...
ax[1].tick_params(axis='x', labelsize=35, labelrotation=90)
...
ax[2].tick_params(axis='x', labelsize=35, labelrotation=90)
